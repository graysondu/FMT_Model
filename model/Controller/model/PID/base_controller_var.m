...
CONTROL_PARAM_VALUE.VEL_Z_D = single(0.005);
...
CONTROL_PARAM_VALUE.ROLL_RATE_I = single(0.075);
CONTROL_PARAM_VALUE.PITCH_RATE_I = single(0.075);
CONTROL_PARAM_VALUE.YAW_RATE_I = single(0.075);
CONTROL_PARAM_VALUE.ROLL_RATE_D = single(0.004);
CONTROL_PARAM_VALUE.PITCH_RATE_D = single(0.004);
